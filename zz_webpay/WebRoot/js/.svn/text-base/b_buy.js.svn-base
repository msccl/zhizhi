...
function fillForm() {
	try {
		...
		document.getElementById("num_1").innerHTML=document.getElementById("num").value;
		document.getElementById("num_2").innerHTML=document.getElementById("num").value;
        ...
        if(buynum > 1) {
        	totalExpress = parseFloat(parseFloat(expressValue)+parseFloat(expressIncrement)*(buynum-1)).toFixed(2);
			document.getElementById("moneytotal").innerHTML= parseFloat(parseFloat(document.getElementById("price").value)*buynum + parseFloat(totalExpress)).toFixed(2);
			document.getElementById("method_cost").innerHTML= totalExpress;
		} else {
			document.getElementById("method_cost").innerHTML= expressValue;
			document.getElementById("moneytotal").innerHTML= parseFloat(parseFloat(document.getElementById("price").value) + parseFloat(expressValue)).toFixed(2);
		}
		//document.getElementById("expressunique").innerHTML= expressUnique;
	}catch(e) {
	}
}
